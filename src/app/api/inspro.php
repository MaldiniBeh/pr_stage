...
if (isset($postdata) && !empty($postdata)) {
  ...
  //var_dump(json_decode($request->data->competence));

  //echo  $request;
  // exit();
  $insert = dbase()->prepare("INSERT INTO Stagiare(nom,prenom,date_naissance,residence,email,tel,situa_mat,salaire,sexe,competence)
    VALUES(?,?,?,?,?,?,?,?,?,?)");
  ...
  if ($succ) {
    ...
    $stage = [
      ...
      'salaire' => $request->data->id_etabli,
      'competence' => $request->data->competence
